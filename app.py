...
csv_file_path = '/Users/livmuehlberg/eclipse-workspace/Routes/Rest_Areas.csv' #reaffirming the path
...
def query3(data):
    ...
    if st.button("Generate Chart!"): # streamlit button to display data
        filtered_data = data[data['CITY'].isin(selected_cities)] if selected_data else data # counts occurrances and prep data, list comp.
...
def query4(data):
    ...
    csv_file_path = '/Users/livmuehlberg/eclipse-workspace/Routes/Rest_Areas.csv'
    data = load_data(csv_file_path)
